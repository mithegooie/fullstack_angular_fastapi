...
import { Auth0ResourceModel } from '../../core/models';

@Component({
  selector: 'app-page-footer',
  standalone: true,
  imports: [PageFooterHyperlinkComponent],
  template: `
    <footer class="page-footer">
      <div class="page-footer-grid">
        ...
        <div class="page-info-grid__brand">
...
export class PageFooterComponent {
  resourceList: Auth0ResourceModel[] = [
    ...
    {
      path: 'https://auth0.com/get-started/',
      label: 'How It Works',
    },
    {
      path: 'https://auth0.com/developers/',
